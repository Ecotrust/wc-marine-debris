...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectDataSheet'
        db.create_table('core_projectdatasheet', (
        ...
        db.send_create_signal('core', ['ProjectDataSheet'])


        # Changing field 'Event.type_id'
        db.alter_column('core_event', 'type_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.EventType'], null=True))
        # Deleting field 'DataSheet.media_id'
        db.delete_column('core_datasheet', 'media_id_id')

        # Adding field 'DataSheet.type_id'
        db.add_column('core_datasheet', 'type_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.EventType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ProjectDataSheet'
        db.delete_table('core_projectdatasheet')


        # Changing field 'Event.type_id'
        db.alter_column('core_event', 'type_id_id', self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['core.EventType']))
        # Adding field 'DataSheet.media_id'
        db.add_column('core_datasheet', 'media_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Media'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DataSheet.type_id'
        db.delete_column('core_datasheet', 'type_id_id')
