...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Event', fields ['cleanupdate', 'proj_id', 'site', 'datasheet_id']
        db.delete_unique('core_event', ['cleanupdate', 'proj_id_id', 'site_id', 'datasheet_id_id'])

        # Adding field 'Event.dup'
        db.add_column('core_event', 'dup',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding unique constraint on 'Event', fields ['dup', 'cleanupdate', 'proj_id', 'site', 'datasheet_id']
        db.create_unique('core_event', ['dup', 'cleanupdate', 'proj_id_id', 'site_id', 'datasheet_id_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Event', fields ['dup', 'cleanupdate', 'proj_id', 'site', 'datasheet_id']
        db.delete_unique('core_event', ['dup', 'cleanupdate', 'proj_id_id', 'site_id', 'datasheet_id_id'])

        # Deleting field 'Event.dup'
        db.delete_column('core_event', 'dup')

        # Adding unique constraint on 'Event', fields ['cleanupdate', 'proj_id', 'site', 'datasheet_id']
        db.create_unique('core_event', ['cleanupdate', 'proj_id_id', 'site_id', 'datasheet_id_id'])
    ...
    models = {
        ...
        'core.event': {
            ...
            'cleanupdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 8, 0, 0)'}),
