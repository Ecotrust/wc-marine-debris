...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.cleanupdate'
        db.alter_column('core_event', 'cleanupdate', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Event.cleanupdate'
        db.alter_column('core_event', 'cleanupdate', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'core.event': {
            ...
            'cleanupdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 27, 0, 0)'}),
