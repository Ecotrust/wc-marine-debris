...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_grouping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('core', ['Grouping'])

        # Deleting field 'DataSheetField.category'
        db.delete_column('core_datasheetfield', 'category_id')

        # Adding field 'DataSheetField.grouping'
        db.add_column('core_datasheetfield', 'grouping',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Grouping'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'EventType.display_sites'
        db.add_column('core_eventtype', 'display_sites',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Field.datatype'
        db.alter_column('core_field', 'datatype', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Adding field 'Unit.data_type'
        db.add_column('core_unit', 'data_type',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('core_grouping')

        # Adding field 'DataSheetField.category'
        db.add_column('core_datasheetfield', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Category'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DataSheetField.grouping'
        db.delete_column('core_datasheetfield', 'grouping_id')

        # Deleting field 'EventType.display_sites'
        db.delete_column('core_eventtype', 'display_sites')


        # Changing field 'Field.datatype'
        db.alter_column('core_field', 'datatype', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))
        # Deleting field 'Unit.data_type'
        db.delete_column('core_unit', 'data_type_id')
