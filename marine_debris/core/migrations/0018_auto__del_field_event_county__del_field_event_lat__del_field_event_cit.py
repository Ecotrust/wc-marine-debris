...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.county'
        db.delete_column('core_event', 'county')

        # Deleting field 'Event.lat'
        db.delete_column('core_event', 'lat')

        # Deleting field 'Event.city'
        db.delete_column('core_event', 'city')

        # Deleting field 'Event.sitename'
        db.delete_column('core_event', 'sitename')

        # Deleting field 'Event.lon'
        db.delete_column('core_event', 'lon')

        # Deleting field 'Event.state'
        db.delete_column('core_event', 'state_id')

        # Adding field 'Event.site'
        db.add_column('core_event', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Site'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Event.county'
        db.add_column('core_event', 'county',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.lat'
        db.add_column('core_event', 'lat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.city'
        db.add_column('core_event', 'city',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.sitename'
        db.add_column('core_event', 'sitename',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.lon'
        db.add_column('core_event', 'lon',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.state'
        db.add_column('core_event', 'state',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.State']),
                      keep_default=False)

        # Deleting field 'Event.site'
        db.delete_column('core_event', 'site_id')
    ...
    models = {
        ...
        'core.event': {
            'Meta': {'ordering': "['proj_id__projname', 'site', 'cleanupdate']", 'object_name': 'Event'},
