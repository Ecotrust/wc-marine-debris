...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Event', fields ['dup', 'cleanupdate', 'site']
        db.create_unique('core_event', ['dup', 'cleanupdate', 'site_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Event', fields ['dup', 'cleanupdate', 'site']
        db.delete_unique('core_event', ['dup', 'cleanupdate', 'site_id'])
    ...
    models = {
        ...
        'core.event': {
            'Meta': {'ordering': "['proj_id__projname', 'site', 'cleanupdate']", 'unique_together': "(('cleanupdate', 'site', 'dup'),)", 'object_name': 'Event'},
