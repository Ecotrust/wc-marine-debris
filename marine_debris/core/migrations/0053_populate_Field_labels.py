...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for field in orm.Field.objects.filter(label=None):
            field.label = field.internal_name.replace("_"," ").title()
            field.save()
    ...
    models = {
        ...
        'core.event': {
            ...
            'cleanupdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 7, 0, 0)'}),
        ...
        'core.usertransaction': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 7, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
