...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_organization', 'phone', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Organization.contact'
        db.alter_column('core_organization', 'contact', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Organization.phone'
        db.alter_column('core_organization', 'phone', self.gf('django.db.models.fields.TextField')(default='111-222-3333'))

        # Changing field 'Organization.contact'
        db.alter_column('core_organization', 'contact', self.gf('django.db.models.fields.TextField')(default='name'))
    ...
    models = {
        ...
        'core.organization': {
            ...
            'contact': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'orgname': ('django.db.models.fields.TextField', [], {}),
            'phone': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
