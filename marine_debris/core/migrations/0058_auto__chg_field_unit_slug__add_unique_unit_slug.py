...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Unit.slug'
        db.alter_column('core_unit', 'slug', self.gf('django.db.models.fields.TextField')(default='tmp', unique=True))
        # Adding unique constraint on 'Unit', fields ['slug']
        db.create_unique('core_unit', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Unit', fields ['slug']
        db.delete_unique('core_unit', ['slug'])


        # Changing field 'Unit.slug'
        db.alter_column('core_unit', 'slug', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'core.event': {
            ...
            'cleanupdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 30, 0, 0)'}),
        ...
        'core.usertransaction': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 30, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
