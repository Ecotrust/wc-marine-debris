...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Download.thefile'
        db.add_column('core_download', 'thefile',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Download.description'
        db.alter_column('core_download', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Download.thefile'
        db.delete_column('core_download', 'thefile')


        # Changing field 'Download.description'
        db.alter_column('core_download', 'description', self.gf('django.db.models.fields.TextField')(default=''))
