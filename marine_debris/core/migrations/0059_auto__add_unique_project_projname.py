...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Project', fields ['projname']
        db.create_unique('core_project', ['projname'])


    def backwards(self, orm):
        # Removing unique constraint on 'Project', fields ['projname']
        db.delete_unique('core_project', ['projname'])
