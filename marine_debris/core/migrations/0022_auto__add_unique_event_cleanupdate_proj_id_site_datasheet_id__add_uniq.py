...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Site', fields ['sitename', 'county', 'state']
        db.create_unique('core_site', ['sitename', 'county', 'state_id'])

        # Adding unique constraint on 'Site', fields ['lat', 'lon']
        db.create_unique('core_site', ['lat', 'lon'])


    def backwards(self, orm):
        # Removing unique constraint on 'Site', fields ['lat', 'lon']
        db.delete_unique('core_site', ['lat', 'lon'])

        # Removing unique constraint on 'Site', fields ['sitename', 'county', 'state']
        db.delete_unique('core_site', ['sitename', 'county', 'state_id'])
    ...
    models = {
        ...
        'core.event': {
            ...
            'cleanupdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 29, 0, 0)'}),
