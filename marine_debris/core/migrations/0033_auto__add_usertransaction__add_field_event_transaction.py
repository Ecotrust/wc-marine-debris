...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_usertransaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('submitted_by', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='New', max_length=30, blank=True)),
        ))
        db.send_create_signal('core', ['UserTransaction'])

        # Adding field 'Event.transaction'
        db.add_column('core_event', 'transaction',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.UserTransaction'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'UserTransaction'
        db.delete_table('core_usertransaction')

        # Deleting field 'Event.transaction'
        db.delete_column('core_event', 'transaction_id')
    ...
    models = {
        ...
        'core.event': {
            ...
            'cleanupdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 24, 0, 0)'}),
            ...
            'transaction': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.UserTransaction']", 'null': 'True'})
        },
        'core.eventtype': {
