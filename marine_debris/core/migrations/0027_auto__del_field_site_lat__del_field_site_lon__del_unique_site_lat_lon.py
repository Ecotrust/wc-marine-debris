...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('core_site', 'lat')

        # Deleting field 'Site.lon'
        db.delete_column('core_site', 'lon')


    def backwards(self, orm):
        # Adding field 'Site.lat'
        db.add_column('core_site', 'lat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Site.lon'
        db.add_column('core_site', 'lon',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'core.event': {
            ...
            'cleanupdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 2, 0, 0)'}),
