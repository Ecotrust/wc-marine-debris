...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataSheet.sheet_description'
        db.add_column('core_datasheet', 'sheet_description',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DataSheet.protocol_description'
        db.add_column('core_datasheet', 'protocol_description',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Field.description'
        db.add_column('core_field', 'description',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataSheet.sheet_description'
        db.delete_column('core_datasheet', 'sheet_description')

        # Deleting field 'DataSheet.protocol_description'
        db.delete_column('core_datasheet', 'protocol_description')

        # Deleting field 'Field.description'
        db.delete_column('core_field', 'description')
    ...
    models = {
        ...
        'core.event': {
            ...
            'cleanupdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 26, 0, 0)'}),
        ...
        'core.usertransaction': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 26, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
