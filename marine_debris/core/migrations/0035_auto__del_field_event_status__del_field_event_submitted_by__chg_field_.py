...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('core_event', 'status')

        # Deleting field 'Event.submitted_by'
        db.delete_column('core_event', 'submitted_by_id')


        # Changing field 'Event.site'
        db.alter_column('core_event', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Site']))

        # Changing field 'Event.transaction'
        db.alter_column('core_event', 'transaction_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.UserTransaction']))

    def backwards(self, orm):
        # Adding field 'Event.status'
        db.add_column('core_event', 'status',
                      self.gf('django.db.models.fields.CharField')(default='New', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Event.submitted_by'
        db.add_column('core_event', 'submitted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Event.site'
        db.alter_column('core_event', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Site'], null=True))

        # Changing field 'Event.transaction'
        db.alter_column('core_event', 'transaction_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.UserTransaction'], null=True))
    ...
    models = {
        ...
        'core.event': {
            ...
            'cleanupdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 25, 0, 0)'}),
        ...
        'core.site': {
            ...
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.State']", 'null': 'True', 'blank': 'True'})
        },
        'core.state': {
        ...
        'core.usertransaction': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 25, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
