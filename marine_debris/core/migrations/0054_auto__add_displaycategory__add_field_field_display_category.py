...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DisplayCategory'
        db.create_table('core_displaycategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')()),
            ('display_order', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('core', ['DisplayCategory'])

        # Adding field 'Field.display_category'
        db.add_column('core_field', 'display_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.DisplayCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DisplayCategory'
        db.delete_table('core_displaycategory')

        # Deleting field 'Field.display_category'
        db.delete_column('core_field', 'display_category_id')
    ...
    models = {
        ...
        'core.displaycategory': {
            'Meta': {'object_name': 'DisplayCategory'},
        ...
        'core.event': {
            ...
            'cleanupdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 19, 0, 0)'}),
        ...
        'core.usertransaction': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
