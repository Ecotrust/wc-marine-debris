...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'State', fields ['name', 'initials']
        db.create_unique('core_state', ['name', 'initials'])


    def backwards(self, orm):
        # Removing unique constraint on 'State', fields ['name', 'initials']
        db.delete_unique('core_state', ['name', 'initials'])
    ...
    models = {
        ...
        'core.event': {
            ...
            'cleanupdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 3, 0, 0)'}),
