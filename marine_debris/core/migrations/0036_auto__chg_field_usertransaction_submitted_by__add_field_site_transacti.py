...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserTransaction.submitted_by'
        db.alter_column('core_usertransaction', 'submitted_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=4, to=orm['auth.User']))
        # Adding field 'Site.transaction'
        db.add_column('core_site', 'transaction',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.UserTransaction'], null=True),
                      keep_default=False)


        # Changing field 'Site.state'
        db.alter_column('core_site', 'state_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.State']))

    def backwards(self, orm):

        # Changing field 'UserTransaction.submitted_by'
        db.alter_column('core_usertransaction', 'submitted_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
        # Deleting field 'Site.transaction'
        db.delete_column('core_site', 'transaction_id')


        # Changing field 'Site.state'
        db.alter_column('core_site', 'state_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.State'], null=True))
