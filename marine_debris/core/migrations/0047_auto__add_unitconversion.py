...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_unitconversion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_unit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='from_unit', to=orm['core.Unit'])),
            ('to_unit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='to_unit', to=orm['core.Unit'])),
            ('factor', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('core', ['UnitConversion'])


    def backwards(self, orm):
        # Deleting model 'UnitConversion'
        db.delete_table('core_unitconversion')
    ...
    models = {
        ...
        'core.event': {
            ...
            'cleanupdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 4, 0, 0)'}),
        ...
        'core.usertransaction': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 4, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
