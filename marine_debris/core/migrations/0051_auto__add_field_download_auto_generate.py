...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Download.auto_generate'
        db.add_column('core_download', 'auto_generate',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Download.auto_generate'
        db.delete_column('core_download', 'auto_generate')
