...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_field', 'datatype_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.DataType']))

    def backwards(self, orm):

        # Changing field 'Field.datatype'
        db.alter_column('core_field', 'datatype_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.DataType'], null=True))
