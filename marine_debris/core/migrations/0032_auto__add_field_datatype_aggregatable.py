...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataType.aggregatable'
        db.add_column('core_datatype', 'aggregatable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataType.aggregatable'
        db.delete_column('core_datatype', 'aggregatable')
    ...
    models = {
        ...
        'core.event': {
            ...
            'cleanupdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 14, 0, 0)'}),
