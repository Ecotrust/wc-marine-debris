  ...
  steps: [
    {
      ...
      content: 'Use the Map tab to view the location of each event in your query results. Select a cluster of events <img src="' + static_url + 'img/cluster.png" /> to zoom in on them. Select a single event <img src="' + static_url + 'img/event_point.png" /> to learn more about it',
      direction: 'top',
      arrow: {offsetX: 0, offsetY: 0}
    },{
      target: '#details-tab',
