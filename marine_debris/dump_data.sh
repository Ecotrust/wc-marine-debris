...
rm  core/fixtures/dump_data.json.gz
gzip  core/fixtures/dump_data.json
...
rm core/fixtures/update_data.json.gz
gzip core/fixtures/update_data.json
python manage.py dumpdata --indent=2 auth.User flatblocks.flatblock core > core/fixtures/dump_data_w_events.json
rm core/fixtures/dump_data_w_events.json.gz
gzip core/fixtures/dump_data_w_events.json
